...
import { useVVPTestConfig } from '../../api/getTestConfig';
import { useSetVVPTestConfig } from '../../api/setTestConfig';
import { Patient } from '../../types';
import { VVPTestConfig } from '../../types/vvp';
// import { Patient } from '../types';

export const VVPConfiguration = () => {
  ...
  const { data: fetchedData, isLoading: fetchedDataLoading } = useVVPTestConfig({
  ...
  const setTestConfigMutation = useSetVVPTestConfig();
